...
namespace Zor.BehaviorTree.Serialization.SerializedBehaviors.Leaves.Actions
{
	...
	public sealed class SerializedInstantiateObjectInParentAndPosition :
		SerializedAction<InstantiateObjectInParentAndPosition, string, string, string, string, string>
	{
	}
}
