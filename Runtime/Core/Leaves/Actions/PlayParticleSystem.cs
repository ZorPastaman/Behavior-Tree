...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Plays a <see cref="ParticleSystem"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// </para>
	/// </summary>
	public sealed class PlayParticleSystem : Action, ISetupable<BlackboardPropertyName, bool>, ISetupable<string, bool>
	{
		...
		protected override Status Execute()
		{
			if (blackboard.TryGetClassValue(m_particleSystemPropertyName, out ParticleSystem particleSystem) &
				particleSystem != null)
			{
				particleSystem.Play(m_withChildren);
