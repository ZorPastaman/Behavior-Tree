...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Gets a <see cref="Vector3.x"/>, <see cref="Vector3.y"/> and <see cref="Vector3.z"/> and
	/// sets them into the <see cref="Blackboard"/>
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 	</item>
	/// 	<item>
	/// 		<description>Property name for a z result of type <see cref="float"/>.</description>
	/// 	</item>
	/// </list>
	/// </para>
	/// </summary>
