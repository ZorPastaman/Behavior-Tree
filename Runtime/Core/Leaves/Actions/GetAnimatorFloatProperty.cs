...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Gets a <see cref="float"/> property from an <see cref="Animator"/> and sets it into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// </remarks>
	public sealed class GetAnimatorFloatProperty : Action,
		...
		ISetupable<string, int, string>, ISetupable<string, string, string>
	{
		...
		protected override Status Execute()
		{
			...
			{
				float value = animator.GetFloat(m_propertyId);
