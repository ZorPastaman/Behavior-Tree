...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Gets a <see cref="Component"/> of a <see cref="GameObject"/> and sets it into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	public sealed class GetComponent<T> : Action,
		...
		where T : Component
	{
		...
		protected override Status Execute()
		{
			...
			{
				blackboard.SetClassValue(m_componentPropertyName, gameObject.GetComponent<T>());
