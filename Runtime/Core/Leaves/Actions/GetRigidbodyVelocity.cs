...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Gets a <see cref="Rigidbody.velocity"/> and sets it into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// </remarks>
	public sealed class GetRigidbodyVelocity : Action,
		ISetupable<BlackboardPropertyName, BlackboardPropertyName>, ISetupable<string, string>
	{
		...
		protected override Status Execute()
		{
			...
			{
				blackboard.SetStructValue(m_velocityPropertyName, rigidbody.velocity);
