...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Divides vectors and sets a result into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 	</listheader>
	/// 	<item>
	/// 		<description>Property name of a left operand of type <see cref="Vector2"/>.</description>
	/// 	</item>
	/// 	<item>
	/// 		<description>Property name of a right operand of type <see cref="Vector2"/>.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </remarks>
	public sealed class DivideVector2 : Action,
