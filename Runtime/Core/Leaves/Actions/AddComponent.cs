...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Adds a <see cref="Component"/> to a <see cref="GameObject"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 	</listheader>
	/// 	<item>
	/// 		<description>Property name of a targeted <see cref="GameObject"/>.</description>
	/// 	</item>
	/// 	<item>
	/// 		<description>Property name of a created <see cref="Component"/>.</description>
	/// 	</item>
	/// </list>
	/// </para>
	/// </summary>
	/// <remarks>
	/// The result is set into the <see cref="Blackboard"/> and the <see cref="Component"/> is added
	/// only if there's all the data and this <see cref="Action"/> ticks with <see cref="Status.Success"/>.
	/// </remarks>
	/// <typeparam name="T"><see cref="Component"/> type.</typeparam>
	public sealed class AddComponent<T> : Action,
		...
		where T : Component
	{
		...
		protected override Status Execute()
		{
			...
			{
				blackboard.SetClassValue(m_componentPropertyName, gameObject.AddComponent<T>());
