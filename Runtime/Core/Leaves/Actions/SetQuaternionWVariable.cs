...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Sets a <see cref="Quaternion.w"/> and sets a new quaternion into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// </remarks>
	public sealed class SetQuaternionWVariable : Action,
		...
		ISetupable<string, string, string>
	{
		...
		{
			SetupInternal(quaternionPropertyName, wPropertyName, resultPropertyName);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		void ISetupable<string, string, string>.Setup(string quaternionPropertyName, string wPropertyName,
			string resultPropertyName)
		{
			SetupInternal(new BlackboardPropertyName(quaternionPropertyName),
				new BlackboardPropertyName(wPropertyName), new BlackboardPropertyName(resultPropertyName));
		}
