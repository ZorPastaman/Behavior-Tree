...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Gets a <see cref="int"/> property from an <see cref="Animator"/> and sets it into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// </remarks>
	public sealed class GetAnimatorIntProperty : Action,
		...
		ISetupable<string, int, string>, ISetupable<string, string, string>
	{
		...
		protected override Status Execute()
		{
			...
			{
				int value = animator.GetInteger(m_propertyId);
