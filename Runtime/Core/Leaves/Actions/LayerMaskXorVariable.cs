...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Computes a bitwise or of layer masks and sets the result into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 	</item>
	/// 	<item>
	/// 		<description>Property name of a second operand of type <see cref="LayerMask"/>.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </remarks>
	public sealed class LayerMaskXorVariable : Action,
