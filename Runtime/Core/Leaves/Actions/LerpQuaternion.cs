...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Lerps quaternions and sets the result into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// </remarks>
	public sealed class LerpQuaternion : Action,
		...
		ISetupable<string, string, float, string>
	{
		...
		protected override Status Execute()
		{
			...
			{
				blackboard.SetStructValue(m_resultPropertyName, Quaternion.Lerp(from, to, m_time));
