...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Multiplies a <see cref="Vector3"/> by a variable number and sets a result into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 	</item>
	/// 	<item>
	/// 		<description>Property name of a multiplier of type <see cref="float"/>.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </remarks>
	public sealed class MultiplyVector2AndNumberVariable : Action,
