...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Instantiates an <see cref="Object"/> in a parent and pose and sets it into the <see cref="Blackboard"/>.
	/// This <see cref="Action"/> uses <see cref="Object.Instantiate(Object, Vector3, Quaternion, Transform)"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// </remarks>
	public sealed class InstantiateObjectInParentAndPose : Action,
		...
		ISetupable<string, string, string, string, string>
	{
		...
		{
			SetupInternal(objectPropertyName, parentPropertyName, positionPropertyName, rotationPropertyName,
				resultPropertyName);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		void ISetupable<string, string, string, string, string>.Setup(string objectPropertyName,
		...
		protected override Status Execute()
		{
			...
			{
				blackboard.SetClassValue(m_resultPropertyName, Object.Instantiate(@object, position, rotation, parent));
