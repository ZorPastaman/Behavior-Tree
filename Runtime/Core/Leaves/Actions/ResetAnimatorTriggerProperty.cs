...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Resets a trigger in an <see cref="Animator"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 	<item>
	/// 		<description>
	/// 		Property name of a property name or property id of type <see cref="string"/> or <see cref="int"/>.
	/// 		</description>
	/// 	</item>
	/// </list>
	/// </para>
	/// </summary>
	public sealed class ResetAnimatorTriggerProperty : Action,
		...
		ISetupable<string, int>, ISetupable<string, string>
	{
		...
		protected override Status Execute()
		{
			...
			{
				animator.ResetTrigger(m_propertyId);
