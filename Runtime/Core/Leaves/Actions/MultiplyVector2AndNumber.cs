...
namespace Zor.BehaviorTree.Core.Leaves.Actions
{
	/// <summary>
	/// <para>
	/// Multiplies a <see cref="Vector2"/> by a number and sets a result into the <see cref="Blackboard"/>.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 	</item>
	/// 	<item>
	/// 		<description>Multiplier of type <see cref="float"/>.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </remarks>
	public sealed class MultiplyVector2AndNumber : Action,
