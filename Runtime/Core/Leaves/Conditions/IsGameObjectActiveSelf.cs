...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if a <see cref="GameObject"/> is active self.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 		<description>if the <see cref="GameObject"/> is active self.</description>
	/// 	</item>
	/// 	<item>
	/// 		<term><see cref="Status.Failure"/> </term>
	/// 		<description>if the <see cref="GameObject"/> isn't active self.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </para>
	/// </summary>
	public sealed class IsGameObjectActiveSelf : Condition, ISetupable<BlackboardPropertyName>, ISetupable<string>
	{
		...
		protected override Status Execute()
		{
			...
			{
				return StateToStatusHelper.ConditionToStatus(gameObject.activeSelf);
			}
