...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if an angle between vectors is less than a specified value.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 		<description>if the angle is less than the specified angle.</description>
	/// 	</item>
	/// 	<item>
	/// 		<term><see cref="Status.Failure"/> </term>
	/// 		<description>if the angle isn't less than the specified angle.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </para>
	/// </summary>
	public sealed class IsVector2AngleLessVariable : Condition,
		...
		ISetupable<string, string, string>
	{
		...
		protected override Status Execute()
		{
			...
			return StateToStatusHelper.ConditionToStatus(Vector2.Angle(from, to) < angle, hasValues);
		}
	}
}
