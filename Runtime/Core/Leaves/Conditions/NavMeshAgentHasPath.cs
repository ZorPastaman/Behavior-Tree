...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if a <see cref="NavMeshAgent"/> has a path.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 		<description>if the <see cref="NavMeshAgent"/> has a path.</description>
	/// 	</item>
	/// 	<item>
	/// 		<term><see cref="Status.Failure"/> </term>
	/// 		<description>if the <see cref="NavMeshAgent"/> doesn't have a path.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </para>
	/// </summary>
	public sealed class NavMeshAgentHasPath : Condition, ISetupable<BlackboardPropertyName>, ISetupable<string>
	{
		...
		protected override Status Execute()
		{
			...
			{
				return StateToStatusHelper.ConditionToStatus(agent.hasPath);
			}
