...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if a <see cref="Color.g"/> is greater than a specified value.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 		<description>if the color green is greater than the specified green.</description>
	/// 	</item>
	/// 	<item>
	/// 		<term><see cref="Status.Failure"/> </term>
	/// 		<description>if the color green isn't greater than the specified green.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </para>
	/// </summary>
	public sealed class IsColorGreenGreaterVariable : Condition,
