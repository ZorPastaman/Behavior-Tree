...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	...
	/// </para>
	/// </summary>
	public sealed class IsAnimatorBoolPropertyEqualVariable : Condition,
		...
		ISetupable<string, int, BlackboardPropertyName>, ISetupable<string, string, string>
	{
		...
		protected override Status Execute()
		{
			return blackboard.TryGetClassValue(m_animatorPropertyName, out Animator animator) & animator != null &
				blackboard.TryGetStructValue(m_valuePropertyName, out bool value)
					? StateToStatusHelper.ConditionToStatus(animator.GetBool(m_propertyId) == value)
					: Status.Error;
		}
	}
}
