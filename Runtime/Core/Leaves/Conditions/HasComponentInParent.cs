...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if a <see cref="GameObject"/> or its parent have a component of a specified type.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	public sealed class HasComponentInParent<T> : Condition, ISetupable<BlackboardPropertyName>, ISetupable<string>
		where T : Component
	{
		...
		protected override Status Execute()
		{
			...
			{
				return StateToStatusHelper.ConditionToStatus(gameObject.GetComponentInParent<T>() != null);
			}
