...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if a <see cref="ParticleSystem"/> is emitting.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 		<description>if the <see cref="ParticleSystem"/> is emitting.</description>
	/// 	</item>
	/// 	<item>
	/// 		<term><see cref="Status.Failure"/> </term>
	/// 		<description>if the <see cref="ParticleSystem"/> isn't emitting.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </para>
	/// </summary>
	public sealed class IsParticleSystemEmitting : Condition, ISetupable<BlackboardPropertyName>, ISetupable<string>
	{
		...
		protected override Status Execute()
		{
			if (blackboard.TryGetClassValue(m_particleSystemPropertyName, out ParticleSystem particleSystem) &
				particleSystem != null)
			{
				return StateToStatusHelper.ConditionToStatus(particleSystem.isEmitting);
			}
