...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	...
	/// </para>
	/// </summary>
	public sealed class CapsuleCastVariable : Condition,
		...
		ISetupable<string, string, string, string, string, string>
	{
		...
		void ISetupable<BlackboardPropertyName, BlackboardPropertyName, BlackboardPropertyName, BlackboardPropertyName,
			BlackboardPropertyName, BlackboardPropertyName>.Setup(BlackboardPropertyName point1PropertyName,
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		void ISetupable<string, string, string, string, string, string>.Setup(string point1PropertyName,
		...
		protected override Status Execute()
		{
			...
			return StateToStatusHelper.ConditionToStatus(
				Physics.CapsuleCast(point1, point2, radius, direction, maxDistance, layerMask), hasValues);
		}
	}
}
