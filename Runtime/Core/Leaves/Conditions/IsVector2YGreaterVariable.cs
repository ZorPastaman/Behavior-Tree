...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if a <see cref="Vector2.y"/> is greater than a specified value.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 		<description>if the vector y is greater than the specified red.</description>
	/// 	</item>
	/// 	<item>
	/// 		<term><see cref="Status.Failure"/> </term>
	/// 		<description>if the vector y isn't greater than the specified red.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </para>
	/// </summary>
	public sealed class IsVector2YGreaterVariable : Condition,
