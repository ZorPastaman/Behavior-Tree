...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if a <see cref="NavMeshHit"/> distance is less than a specified value.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 		<description>
	/// 		if the <see cref="NavMeshHit"/> distance is less than a specified value.
	/// 		</description>
	/// 	</item>
	/// 	<item>
	/// 		<term><see cref="Status.Failure"/> </term>
	/// 		<description>
	/// 		if the <see cref="NavMeshHit"/> distance isn't less than a specified value.
	/// 		</description>
	/// 	</item>
	/// 	<item>
