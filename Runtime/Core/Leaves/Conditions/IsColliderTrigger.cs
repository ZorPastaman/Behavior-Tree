...
namespace Zor.BehaviorTree.Core.Leaves.Conditions
{
	/// <summary>
	/// <para>
	/// Checks if a <see cref="Collider"/> is a trigger.
	/// </para>
	/// <para>
	/// <list type="bullet">
	/// 	<listheader>
	...
	/// 		<description>if the <see cref="Collider"/> is a trigger.</description>
	/// 	</item>
	/// 	<item>
	/// 		<term><see cref="Status.Failure"/> </term>
	/// 		<description>if the <see cref="Collider"/> isn't a trigger.</description>
	/// 	</item>
	/// 	<item>
	...
	/// </para>
	/// </summary>
	public sealed class IsColliderTrigger : Condition, ISetupable<BlackboardPropertyName>, ISetupable<string>
	{
